...
<div class="card text-bg-info">
	<div class="card-body">
		...
		@endif
			...
			<input placeholder="Masukan Nama" type="text" name="nama_lengkap" id="nama_lengkap" class="form-control" value="{{ $mahasiswa->nama_lengkap }}" readonly>

			<input placeholder="Masukan Nim" type="number" name="nim" id="nim" class="form-control" value="{{ $mahasiswa->nim }}" readonly>
			
			<input placeholder="Masukan Alamat" type="text" name="alamat" id="alamat" class="form-control" value="{{ $mahasiswa->alamat }}" readonly>
			
			<input placeholder="Masukan No.Telepon" type="number" name="no_telepon" id="no_telepon" class="form-control" value="{{ $mahasiswa->no_telepon }}" readonly>
			
			<input placeholder="Masukan Email" type="email" name="email" id="email" class="form-control" value="{{ $mahasiswa->email }}" readonly>

			<label for="tgl_lahir">Tanggal Lahir:</label>
			<input  type="date" name="tgl_lahir" id="tgl_lahir" class="form-control" value="{{ $mahasiswa->tgl_lahir }}" readonly>

			<div class="mb-3">	
				<label for="jenis_kelamin">Jenis Kelamin:</label>
				<input type="radio" id="laki_laki" name="jenis_kelamin" value="laki-laki" class="form-check-input" @if($mahasiswa->jenis_kelamin == 'laki-laki') checked @endif disabled> Laki-laki &nbsp;
				<input  type="radio" id="perempuan" name="jenis_kelamin" value="perempuan" class="form-check-input" @if($mahasiswa->jenis_kelamin == 'perempuan') checked @endif disabled> Perempuan
			</div>
			...
			<a href="{{ route('data-mahasiswa.index') }}" class="btn btn-primary">Kembali</a>
